...
(local
	...
	selected
	status
	[okIText 4] = [{שחזור} {__שמירה__} {החלפה} {החלפה}]
	[textIText 4] = [{בחרי את המשחק שברצונך לשחזר.} {הקלידי את תיאור המשחק השמור.} {התיקייה/דיסק הזה אינם יכולים להכיל משחקים שמורים נוספים. עלייך להחליף את אחד המשחקים השמורים שלך או להשתמש ב"שינוי תיקייה" כדי לשמור בתיקייה/דיסק אחרים.} {התיקייה/דיסק הזה אינם יכולים להכיל משחקים שמורים נוספים. עלייך להחליף את אחד המשחקים השמורים שלך או להשתמש ב"שינוי תיקייה" כדי לשמור בתיקייה/דיסק אחרים.}]
)
