...
(instance actions of Script
	...
	(method (changeState newState &tmp [temp0 12])
		(switch (= state newState)
			...
			(105
				(= global120 (Print 694 3 #at -1 20 #width 240 #title {רוזלה} #dispose)) ; ""How are you feeling, Father?" you excitedly ask him."
				(= seconds 7)
			)
			(106
				(cls)
				(= global120
					(Print 694 4 #at -1 20 #width 240 #title {המלך גרהאם} #dispose) ; ""Never felt better in my life!" is his reply. "What is IN this fruit, anyway?" he wonders."
				)
				(= seconds 7)
			)
			(107
				(cls)
				(= global120 (Print 694 5 #at -1 20 #width 240 #title {רוזלה} #dispose)) ; ""It is MAGIC, Father!" and you tell your excited family of your adventure in Tamir."
				(= seconds 8)
			)
			(108
				(cls)
				...
				(= global120 (Print 694 6 #at -1 138 #width 240 #title {רוזלה} #dispose)) ; "I don't think you're through with this hat, yet!" you say. Your brother, Alexander, and your mother, Queen Valanice, readily agree. "You've got too much life ahead of you!"
				(= seconds 15)
			)
			(109
				(cls)
			...
			(600
				...
				(Print
					(Format @global228 {הקוד הסודי שלך הוא:\n\n___%s} @temp0)
				)
			)
		)
	)
