...
(instance trough of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {זוהי שוקת העז, ריקה כרגע. עזים תמיד רעבות!}
	)
)
...
(instance tree8 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {ישנם עצים יפים רבים המקיפים את מכלאת העזים.}
	)
)
...
(instance bush of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {ישנם שיחים דקורטיביים קטנים רבים פזורים ברחבי דאבנטרי.}
	)
)
