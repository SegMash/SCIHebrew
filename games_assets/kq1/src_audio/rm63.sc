...
(instance rm63 of Rm
	...
	(method (init)
		...
		((ScriptID 0 23) number: 73) ; backSound
		(SciAudio play: {oak.mp3} -1)
...
(instance tree1 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {כאן בעץ, הגזע הראשי כפוף מספיק כדי לאפשר לך ללכת בזהירות לאורכו. העלים והענפים מסתירים את הקרקע מהעין.}
	)
)
