...
(instance rock1 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {זהו אחד מהסלעים והבולדרים הרבים הפזורים ברחבי הארץ.}
	)
)
...
(instance bush1 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {אתה רואה צמחים ושיחים שופעים ברחבי ממלכת דאבנטרי.}
	)
)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(EgoDeadNew
					{הזאב מאמין ב""זאב לזאב אדם"", אז הוא נחמד לזאבים אחרים, אבל אלייך הוא מתייחס כארוחת צהריים.}
				)
			)
		)
	)
...
(instance tree4 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {כל מיני עצים מרהיבים מנקדים את נוף דאבנטרי.}
	)
)
