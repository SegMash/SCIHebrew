...
(instance light1 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {אתה רואה עיגול אור על רצפת המערה, זורח מטה מהחור שמעל.}
	)
)
...
(instance sunbeam1 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {קרן אור שמש מלמעלה חודרת את עגמומיות המערה.}
	)
)
...
(instance wall of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {קירות המערה הזו לחים ומכוסים עובש.}
	)
)
...
(instance stalactite1 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {תצורות סלע אלו נוצרו לאט לאורך אלפי שנים.}
	)
)
