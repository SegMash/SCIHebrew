...
(instance hole of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {החור הזה, חרוט בצד הסלע, הוא הכניסה לביתו של הגמד. חשוך מדי בפנים מכדי להבחין בפרטים, והגמד כנראה מעדיף את זה כך.}
	)
)
...
(instance bush of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {כמה שיחים וצמחים נחמדים מקיפים את בית הגמד.}
	)
)
