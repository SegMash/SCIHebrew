...
(instance tree1 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {זהו אחד מהעצים הקטנים הרבים הפזורים ברחבי נוף דאבנטרי היפה.}
	)
)
...
(instance tree3 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {העצים מעט דלילים כאן למרגלות ההר הסלעי.}
	)
)
...
(instance rock1 of NewFeature
	(properties
		...
		nsBottom 40
		nsRight 112
		description {גבעה סלעית}
		sightAngle 360
		getableDist 320
		seeableDist 320
		shiftClick 369
		contClick 371
		lookStr {הגבעה הסלעית המשוננת הזו חושפת את הכניסה למערה.}
	)
)
...
(instance rock9 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {הרבה סלעים גדולים ובולדרים מפוזרים באזור.}
	)
)
