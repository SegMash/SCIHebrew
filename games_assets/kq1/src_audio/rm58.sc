	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				((ScriptID 0 21) stop:) ; gameSound
				(SciAudio stop:)
				(SciAudio play: {tiredGiant.mp3} 0)
...
(instance tree1 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {העצים כאן גבוהים באופן מפתיע; הם מתנשאים מעל הארץ מעל העננים. בקושי ניתן לראות את צמרותיהם!}
	)
)
...
(instance cloud of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {עננים עבים ודמויי כותנה מקיפים את הארץ כאן, ומסתירים את נוף דאבנטרי הרחוק למטה.}
	)
)
