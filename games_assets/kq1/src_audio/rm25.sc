...
(procedure (localproc_0)
	(localproc_1)
	(Print &rest #title {טרול} #font 4 #at 144 20 #width 150 #dispose)
)
...
(instance bushAndRock of NewFeature
	(properties
		...
		nsBottom 154
		nsRight 76
		description {שיח וסלע}
		sightAngle 360
		getableDist 320
		seeableDist 320
		shiftClick 369
		contClick 371
		lookStr {שיח קטן ורגיל גדל בצל המגן של הסלע.}
	)
)
...
(instance bush1 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {יש יותר שיחים בדאבנטרי מכפי שאתה טורח לשים לב אליהם.}
	)
)
...
(instance river of NewFeature
	(properties
		...
		seeableDist 320
		shiftClick 369
		lookStr {זרם הנהר הסוער הזה מסוכן אף יותר מכפי שהוא נראה.}
	)
)
...
(instance bank of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {גדת הנהר צונחת בחדות כאן. מוטב שתשמור על צעדיך.}
	)
)
...
(instance bridge1 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {גשר לוחות גס חוצה את הנהר העמוק והסוער שמתחת.}
	)
)
