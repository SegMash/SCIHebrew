...
(procedure (localproc_0)
	(localproc_1)
	(Print &rest #title {טרול} #font 4 #at 16 120 #width 280 #dispose)
)
...
(instance pinetree of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {ישנם עצים יפים רבים סביב דאבנטרי.}
	)
)
...
(instance bridge of NewFeature
	(properties
		...
		seeableDist 320
		shiftClick 369
		lookStr {גשר סלע טבעי זה מחבר את היבשת של דאבנטרי לאי קטן.}
	)
)
...
(instance water of NewFeature
	(properties
		...
		seeableDist 320
		shiftClick 369
		lookStr {המים מסוכנים במיוחד כשהם עוברים במורד הזרם דרך הערוץ הזה.}
	)
)
...
(instance water2 of NewFeature
	(properties
		...
		seeableDist 320
		shiftClick 369
		lookStr {הנהר השוצף זורם במהירות דרך הערוץ העמוק הזה.}
	)
)
