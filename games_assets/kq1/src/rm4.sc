		...
		(cond
			...
			((Said 'look,look>')
				(cond
					...
					;((or (Said '/pebble') (Said '/brook[<pebble]'))
					;	(cond
					;		((gEgo has: 9) ; Pebbles
					;			(event claimed: 0)
					;		)
			...
			;((or (Said 'get,get/pebble') (Said 'get,get/pebble<brook'))
			((or (Said 'get,get/brook<pebble') (Said 'get,get/pebble'))
				(cond
...
(instance lake1 of NewFeature
	(properties
		...
		seeableDist 320
		shiftClick 369
		lookStr {זהו אגם הררי שליו עם חוף קטן של חלוקי נחל על שפתו.}
	)
)
...
(instance sand1 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {על החוף ישנם כמה חלוקי נחל חלקים.}
	)
)
...
(instance tree1 of NewFeature
	(properties
		...
		shiftClick 369
		contClick 371
		lookStr {ישנם עצים שופעים רבים המקיפים את האגם.}
	)
)
