...
(instance notice2Room of Rm
	...
	(method (init)
		...
		(RedrawCast)
		(Display {מבוא} dsCOORD 233 76 dsALIGN alLEFT dsFONT 300 dsCOLOR 6)
		(Display {התחל גיבור חדש} dsCOORD 200 105 dsALIGN alLEFT dsFONT 300 dsCOLOR 6)
		(Display {המשך הרפתקה} dsCOORD 206 139 dsALIGN alLEFT dsFONT 300 dsCOLOR 6)
		(Display {מבוא} dsCOORD 232 76 dsALIGN alLEFT dsFONT 300 dsCOLOR 0)
		(Display {התחל גיבור חדש} dsCOORD 199 105 dsALIGN alLEFT dsFONT 300 dsCOLOR 0)
		(Display {המשך הרפתקה} dsCOORD 205 139 dsALIGN alLEFT dsFONT 300 dsCOLOR 0)
		(= local4 1)
		((= local3 (View new:))
			view: 100
			setLoop: 2
