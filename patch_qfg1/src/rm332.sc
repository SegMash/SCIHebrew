...
(local
	[local14 41] = ['/silver,alm,alm' '/gold' '/food,ration' '/mandrake' '/key' '/blade' '/dagger' '/leather,armor' '/shield' '/note,message,note,scroll' '/apple,apple' '/carrot,produce' '/gem[<magic,glowing]' '/vase' '/candelabra' '/music,chest,box' '/candlestick' '/pearl,necklace,string' '/ring[<healer,gold]' '/seed' '/boulder' '/flower' '/lockpick[<hasp]' '/kit[<thief,implement]' '/certificate[<thief]' '/bottle[<empty,!*]' '/fur[<green]' '/dust<faerie,magic' '/water,(bottle<water)' '/mushroom[<magic]' '/claw[<cheetaur]' '/beard[<troll]' '/chainmail,chain,chainmail' '/healing,(healing<potion)' '/mana<potion,magic<potion,power<potion' '/vigor<potion,stamina<potion' '/hero<potion,heroism<potion' '/disenchant,disenchant<potion' '/grease,(ghost,ghoul<potion,grease)' '/mirror[<magic,hand]' '/acorn[<dryad,magic]']
)


(procedure (NewSaidInv event &tmp index obj)
	(for ((= index 0)) (< index 41) ((++ index))
		(if (Said [local14 index])
			(return (+ index 1))
		)
	)
	(event claimed: 1)
...
(instance rm332 of Rm
	...
	(method (handleEvent event &tmp temp0 temp1 temp2 [temp3 60])
		(cond
			...
			((Said 'fence,sell>')
				(= temp2 [gInvNum (= temp1 (NewSaidInv event))])
				(cond
					((not (gEgo inRect: 150 115 205 125))
						(HighPrint 332 26) ; "Go up to the window, please."
					)
