...
(local
	[local0 41] = ['/silver,alm,alm' '/gold' '/food,ration' '/mandrake' '/key' '/blade' '/dagger' '/leather,armor' '/shield' '/note,message,note,scroll' '/apple,apple' '/carrot,produce' '/gem[<magic,glowing]' '/vase' '/candelabra' '/box<music' '/candlestick' '/pearl,necklace,string' '/ring[<healer,gold]' '/seed' '/boulder' '/flower' '/lockpick[<hasp]' '/kit[<thief,implement]' '/certificate[<thief]' '/bottle[<empty,!*]' '/fur[<green]' '/dust<faerie,magic' '/water,(bottle<water)' '/mushroom[<magic]' '/claw[<cheetaur]' '/beard[<troll]' '/chainmail,chain,chainmail' '/healing,(healing<potion)' '/mana,power,magic<potion' '/vigor<potion,stamina<potion' '/hero<potion,heroism<potion' '/disenchant,disenchant<potion' '/grease,(ghost,ghoul<potion,grease)' '/mirror[<magic,hand]' '/acorn[<dryad,magic]']
