...
(procedure (localproc_1 &tmp temp0 [temp1 200])
	...
	(if (gEgo inRect: 190 115 250 124)
		...
		(switch temp0
			...
			(1
				(Format @temp1 311 3 (if (IsFlag 127) {הקודם} else {אחרון})) ; "The %s entry was made several years ago. It says: "Baronet Barnard von Spielburg killed a Troll near the Flying Falls on this 23 day of Octember"."
				(HighPrint @temp1)
			)
			(else
