...
python scripts\text\translate_texts.py SCICompanion-3.2.4.0\kq4_resources patch_kq4\bin .\output_kq4\single_mapping.txt

python.exe .\scripts\vocab\vocab_import.py output_kq4 kq4_work patch_kq4\bin
