...
python scripts\text\translate_texts.py SCICompanion-3.2.4.0\qfg1_resources patch_qfg1\bin .\output_qfg1\single_mapping.txt

python.exe .\scripts\vocab\vocab_import.py output_qfg1 qfg1_work patch_qfg1\bin
